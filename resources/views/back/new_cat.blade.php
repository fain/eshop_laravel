...
@section('content')
    ...
    <div class="col-md-9">
        <div class="cat-cont">
            ...
            <form class="form-horizontal" method="post" action="/backend/new_categories_handler">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <div class="checkbox">
                            <label>
                                <input name="menu_set" type="checkbox" value="Y" @if(old('menu_set') =="Y") checked="checked" @endif>
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <select class="form-control" id="cat_type" name="type">
                            ...
                            <option value="main" @if(old('menu_type')=="main") selected="selected" @endif>Main Category</option>
                            <option value="sub" @if(old('menu_type')=="sub") selected="selected" @endif>Sub Category</option>
                        </select>
                    </div>
                </div>
                        ...
                        @if(count($maincat)>0)
                            <select class="form-control" name="main_cat_id">
                                ...
                                @foreach($maincat as $mc)
                                    <option value="{{ $mc->id }}" @if(old('main_category_id')==$mc->id) selected="selected" @endif>{{ ucfirst(strtolower($mc->name)) }}</option>
                                @endforeach
                            </select>
                        @else
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <select class="form-control" name="status">
                            <option value="A" @if(old('status')=="A") selected="selected" @endif>Active</option>
                            <option value="N" @if(old('status')=="N") selected="selected" @endif>Not Active</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-3 col-md-offset-3">
                        <button type="submit" name="submit_cat" class="btn btn-info">Save</button>
