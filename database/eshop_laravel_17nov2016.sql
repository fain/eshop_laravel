...
--
-- Table structure for table `product_option_bridge`
--

CREATE TABLE `product_option_bridge` (
  `id` int(11) NOT NULL,
  `product_option_group_id` int(11) NOT NULL,
...
(3, 'Aiman Zaidan', 'aiman@multibase.com.my', '$2y$10$YcAwNhmlPa7DcBZTNqEbVueCpYg5TN4Tfz7JtMkw5zhjzHbSOfi.G', 'Admin', 'lo0aSBUQirLpc4AmMv9Y2MQE9RTHAQzGENmDZETOtxsNw6AcgyMTlXqETgA4', '2016-10-27 20:46:28', '2016-11-10 23:24:35');
...
--
-- Indexes for table `product_option_bridge`
--
ALTER TABLE `product_option_bridge`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `product_option`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `product_option_bridge`
--
ALTER TABLE `product_option_bridge`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
